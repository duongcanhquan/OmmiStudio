/** Theme + arc từ vox-director — nhìn cắt giấy editorial, không phải poster phẳng. */
...
export const VOX_KIND_COMPOSITION: Partial<Record<VoxLayoutKind, VoxComposition>> =
  {
    'vox-listicle': 'list',
...
/** 14 cung kể chuyện từ beat-layer.md — chọn ở bước kịch bản. */
export const VOX_ARCS: { value: string; label: string }[] = [
  { value: 'hook_payoff', label: 'Hook → dựng → payoff (mặc định explainer)' },
  { value: 'pas', label: 'PAS — vấn đề → khuấy → giải' },
  { value: 'bab', label: 'BAB — trước → sau → cầu nối' },
  { value: 'aida', label: 'AIDA — chú ý → muốn → hành động' },
  { value: 'storybrand', label: 'StoryBrand — khách là hero' },
  { value: 'how_it_works', label: 'Cách hoạt động / từng bước' },
  { value: 'timeline', label: 'Dòng thời gian / tiến hóa' },
  { value: 'man_in_hole', label: 'Rơi xuống rồi trèo lên' },
  { value: 'story_spine', label: 'Story spine — ngày xưa… cho đến khi' },
  { value: 'origin', label: 'Nguồn gốc / vì sao tồn tại' },
  { value: 'myth_buster', label: 'Phá tin đồn — FACT trước' },
  { value: 'listicle', label: 'Listicle — N cách / mẹo' },
  { value: 'three_act', label: 'Ba hồi — mở / đối đầu / kết' },
  { value: 'story_circle', label: 'Vòng kể — đi tìm rồi đổi' },
]
